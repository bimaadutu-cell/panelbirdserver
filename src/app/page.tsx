...
import { Lock, Mail, User, ArrowRight, ShieldAlert, CheckCircle2, Shield } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans">
      {/* Background White Neon Glow Effect */}
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        ...
        <div className="text-center space-y-2">
          <div className="w-14 h-14 bg-white text-black rounded-2xl mx-auto flex items-center justify-center font-black text-2xl shadow-[0_0_25px_rgba(255,255,255,0.6)]">
            B
          </div>
        ...
        {/* Login Card */}
        <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-8 shadow-2xl space-y-6 relative backdrop-blur-xl">
          ...
          {errorMsg && (
            <div className="p-3.5 rounded-xl bg-red-950/80 border border-red-800/80 text-red-400 text-xs flex items-center gap-2">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl font-bold text-xs bg-white text-black hover:bg-zinc-200 transition-all flex items-center justify-center space-x-2 shadow-[0_0_20px_rgba(255,255,255,0.3)] disabled:opacity-50"
            >
        ...
        <div className="text-center text-xs text-zinc-400">
          Birdserver V1 Production Server Management Panel &copy; 2026 BimzOfficial
        </div>
      </div>
    </div>
  );
